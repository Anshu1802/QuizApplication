...
class Questions : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            if (selecedOption != 0) {
                ...
                setColor(question.correctanswer, R.drawable.correct_option)
                if (currentPosition == questionList!!.size)
                    submit.text = "હવે સમાપ્ત કરો"
                else
                    submit.text = "આગળ વધો"
            } else {
                currentPosition++
    ...
    fun setOptionStyle() {
        ...
        for (op in optionList) {
            ...
            op.background = ContextCompat.getDrawable(this, R.drawable.questionoption_bg)
    ...
    fun selectedOptionStyle(view: TextView, opt: Int) {
        ...
        setOptionStyle()
        selecedOption = opt
        view.background = ContextCompat.getDrawable(this, R.drawable.correct_option)
